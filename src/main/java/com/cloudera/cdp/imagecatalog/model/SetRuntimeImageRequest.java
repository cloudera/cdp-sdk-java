...
/**
 * Adds or updates a runtime image in a catalog
 **/
@javax.annotation.Generated(value = "com.cloudera.cdp.client.codegen.CdpSDKJavaCodegen", date = "2022-02-02T18:44:25.437-08:00")
public class SetRuntimeImageRequest  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SetRuntimeImageRequest setRuntimeImageRequest = (SetRuntimeImageRequest) o;
    if (!Objects.equals(this.catalogName, setRuntimeImageRequest.catalogName)) {
      return false;
    }
    if (!Objects.equals(this.sourceImageId, setRuntimeImageRequest.sourceImageId)) {
      return false;
    }
    if (!Objects.equals(this.vmImages, setRuntimeImageRequest.vmImages)) {
      return false;
    }
    if (!Objects.equals(this.imageId, setRuntimeImageRequest.imageId)) {
      return false;
    }
    if (!Objects.equals(this.baseParcelUrl, setRuntimeImageRequest.baseParcelUrl)) {
      return false;
    }
    return true;
  }
  ...
  public String toString() {
    ...
    sb.append("class SetRuntimeImageRequest {\n");
