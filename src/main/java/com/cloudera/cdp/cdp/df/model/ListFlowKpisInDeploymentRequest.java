...
public class ListFlowKpisInDeploymentRequest  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ListFlowKpisInDeploymentRequest listFlowKpisInDeploymentRequest = (ListFlowKpisInDeploymentRequest) o;
    if (!Objects.equals(this.deploymentCrn, listFlowKpisInDeploymentRequest.deploymentCrn)) {
      return false;
    }
    if (!Objects.equals(this.deployedFlowCrn, listFlowKpisInDeploymentRequest.deployedFlowCrn)) {
      return false;
    }
    if (!Objects.equals(this.metricsTimePeriod, listFlowKpisInDeploymentRequest.metricsTimePeriod)) {
      return false;
    }
    return true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(deploymentCrn, deployedFlowCrn, metricsTimePeriod);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListFlowKpisInDeploymentRequest {\n");
