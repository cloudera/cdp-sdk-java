...
import com.cloudera.cdp.df.model.DeployedFlow;
...
public class DescribeFlowInDeploymentResponse extends CdpResponse {

  /**
   * The deployed flow.
   **/
  private DeployedFlow deployedFlow = null;
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DescribeFlowInDeploymentResponse describeFlowInDeploymentResponse = (DescribeFlowInDeploymentResponse) o;
    if (!Objects.equals(this.deployedFlow, describeFlowInDeploymentResponse.deployedFlow)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
  ...
  public String toString() {
    ...
    sb.append("class DescribeFlowInDeploymentResponse {\n");
