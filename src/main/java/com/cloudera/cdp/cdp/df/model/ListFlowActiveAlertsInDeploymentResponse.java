...
public class ListFlowActiveAlertsInDeploymentResponse extends CdpResponse {

  /**
   * The events for the specified deployed flow.
   **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ListFlowActiveAlertsInDeploymentResponse listFlowActiveAlertsInDeploymentResponse = (ListFlowActiveAlertsInDeploymentResponse) o;
    if (!Objects.equals(this.eventSummaries, listFlowActiveAlertsInDeploymentResponse.eventSummaries)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
  ...
  public String toString() {
    ...
    sb.append("class ListFlowActiveAlertsInDeploymentResponse {\n");
