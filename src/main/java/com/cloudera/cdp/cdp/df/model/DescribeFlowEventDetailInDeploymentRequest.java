...
public class DescribeFlowEventDetailInDeploymentRequest  {
  ...
  /**
   * The CRN of the event to be described.
   **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DescribeFlowEventDetailInDeploymentRequest describeFlowEventDetailInDeploymentRequest = (DescribeFlowEventDetailInDeploymentRequest) o;
    if (!Objects.equals(this.deploymentCrn, describeFlowEventDetailInDeploymentRequest.deploymentCrn)) {
      return false;
    }
    if (!Objects.equals(this.deployedFlowCrn, describeFlowEventDetailInDeploymentRequest.deployedFlowCrn)) {
      return false;
    }
    if (!Objects.equals(this.eventCrn, describeFlowEventDetailInDeploymentRequest.eventCrn)) {
      return false;
    }
    return true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(deploymentCrn, deployedFlowCrn, eventCrn);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeFlowEventDetailInDeploymentRequest {\n");
