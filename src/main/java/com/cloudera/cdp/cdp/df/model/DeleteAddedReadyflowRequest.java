...
public class DeleteAddedReadyflowRequest  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DeleteAddedReadyflowRequest deleteAddedReadyflowRequest = (DeleteAddedReadyflowRequest) o;
    if (!Objects.equals(this.addedReadyflowCrn, deleteAddedReadyflowRequest.addedReadyflowCrn)) {
      return false;
    }
    return true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(addedReadyflowCrn);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteAddedReadyflowRequest {\n");
