...
public class DescribeFlowInDeploymentRequest  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DescribeFlowInDeploymentRequest describeFlowInDeploymentRequest = (DescribeFlowInDeploymentRequest) o;
    if (!Objects.equals(this.deploymentCrn, describeFlowInDeploymentRequest.deploymentCrn)) {
      return false;
    }
    if (!Objects.equals(this.deployedFlowCrn, describeFlowInDeploymentRequest.deployedFlowCrn)) {
      return false;
    }
    return true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(deploymentCrn, deployedFlowCrn);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeFlowInDeploymentRequest {\n");
