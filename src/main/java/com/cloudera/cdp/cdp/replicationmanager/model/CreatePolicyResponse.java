...
public class CreatePolicyResponse extends CdpResponse {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    if (!Objects.equals(this.clusterCrn, createPolicyResponse.clusterCrn)) {
      return false;
    }
    if (!Objects.equals(this.requestId, createPolicyResponse.requestId)) {
      return false;
    }
    if (!Objects.equals(this.message, createPolicyResponse.message)) {
      return false;
    }
    if (!Objects.equals(this.status, createPolicyResponse.status)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
