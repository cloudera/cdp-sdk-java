...
public class ModelRegistryProvisionK8sRequest  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ModelRegistryProvisionK8sRequest modelRegistryProvisionK8sRequest = (ModelRegistryProvisionK8sRequest) o;
    if (!Objects.equals(this.tags, modelRegistryProvisionK8sRequest.tags)) {
      return false;
    }
    if (!Objects.equals(this.network, modelRegistryProvisionK8sRequest.network)) {
      return false;
    }
    return true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tags, network);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ModelRegistryProvisionK8sRequest {\n");
