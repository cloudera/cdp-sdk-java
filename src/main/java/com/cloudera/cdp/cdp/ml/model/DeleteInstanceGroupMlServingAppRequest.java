...
public class DeleteInstanceGroupMlServingAppRequest  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DeleteInstanceGroupMlServingAppRequest deleteInstanceGroupMlServingAppRequest = (DeleteInstanceGroupMlServingAppRequest) o;
    if (!Objects.equals(this.appCrn, deleteInstanceGroupMlServingAppRequest.appCrn)) {
      return false;
    }
    if (!Objects.equals(this.instanceGroupName, deleteInstanceGroupMlServingAppRequest.instanceGroupName)) {
      return false;
    }
    return true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(appCrn, instanceGroupName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteInstanceGroupMlServingAppRequest {\n");
