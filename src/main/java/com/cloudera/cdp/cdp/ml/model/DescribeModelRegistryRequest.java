...
public class DescribeModelRegistryRequest  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DescribeModelRegistryRequest describeModelRegistryRequest = (DescribeModelRegistryRequest) o;
    if (!Objects.equals(this.modelRegistryCrn, describeModelRegistryRequest.modelRegistryCrn)) {
      return false;
    }
    return true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(modelRegistryCrn);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeModelRegistryRequest {\n");
