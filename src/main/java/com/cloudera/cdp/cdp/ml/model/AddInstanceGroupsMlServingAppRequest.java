...
public class AddInstanceGroupsMlServingAppRequest  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AddInstanceGroupsMlServingAppRequest addInstanceGroupsMlServingAppRequest = (AddInstanceGroupsMlServingAppRequest) o;
    if (!Objects.equals(this.appCrn, addInstanceGroupsMlServingAppRequest.appCrn)) {
      return false;
    }
    if (!Objects.equals(this.instanceGroups, addInstanceGroupsMlServingAppRequest.instanceGroups)) {
      return false;
    }
    return true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(appCrn, instanceGroups);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddInstanceGroupsMlServingAppRequest {\n");
