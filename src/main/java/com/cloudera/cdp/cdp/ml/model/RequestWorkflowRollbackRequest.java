...
public class RequestWorkflowRollbackRequest  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RequestWorkflowRollbackRequest requestWorkflowRollbackRequest = (RequestWorkflowRollbackRequest) o;
    if (!Objects.equals(this.workflowType, requestWorkflowRollbackRequest.workflowType)) {
      return false;
    }
    if (!Objects.equals(this.workspaceCrn, requestWorkflowRollbackRequest.workspaceCrn)) {
      return false;
    }
    return true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(workflowType, workspaceCrn);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RequestWorkflowRollbackRequest {\n");
