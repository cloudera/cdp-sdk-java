...
import com.cloudera.cdp.drscp.model.SimpleBackup;
import java.util.*;
...
public class ListBackupsResponse extends CdpResponse {
   ...
   **/
  private List<SimpleBackup> backups = new ArrayList<SimpleBackup>();
  ...
  public List<SimpleBackup> getBackups() {
    return backups;
  }
   ...
   * List of backups for the control plane.
   **/
  public void setBackups(List<SimpleBackup> backups) {
