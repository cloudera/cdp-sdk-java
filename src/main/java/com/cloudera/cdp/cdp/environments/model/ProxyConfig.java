...
public class ProxyConfig  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    if (!Objects.equals(this.proxyConfigName, proxyConfig.proxyConfigName)) {
      return false;
    }
    if (!Objects.equals(this.crn, proxyConfig.crn)) {
      return false;
    }
    if (!Objects.equals(this.protocol, proxyConfig.protocol)) {
      return false;
    }
    if (!Objects.equals(this.host, proxyConfig.host)) {
      return false;
    }
    if (!Objects.equals(this.port, proxyConfig.port)) {
      return false;
    }
