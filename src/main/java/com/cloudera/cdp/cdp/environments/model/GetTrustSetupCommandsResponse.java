...
public class GetTrustSetupCommandsResponse extends CdpResponse {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GetTrustSetupCommandsResponse getTrustSetupCommandsResponse = (GetTrustSetupCommandsResponse) o;
    if (!Objects.equals(this.environment, getTrustSetupCommandsResponse.environment)) {
      return false;
    }
    if (!Objects.equals(this.kdcType, getTrustSetupCommandsResponse.kdcType)) {
      return false;
    }
    if (!Objects.equals(this.activeDirectoryCommands, getTrustSetupCommandsResponse.activeDirectoryCommands)) {
      return false;
    }
    if (!Objects.equals(this.baseClusterCommands, getTrustSetupCommandsResponse.baseClusterCommands)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
  ...
  public String toString() {
    ...
    sb.append("class GetTrustSetupCommandsResponse {\n");
