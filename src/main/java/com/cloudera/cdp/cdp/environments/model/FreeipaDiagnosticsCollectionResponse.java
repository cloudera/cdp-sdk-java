...
import com.cloudera.cdp.environments.model.FreeipaDiagnosticsCollectionDetailsResponse;
import java.time.ZonedDateTime;

/**
 * Response object for diagnostic collection flow details.
 **/
@jakarta.annotation.Generated(value = "com.cloudera.cdp.client.codegen.CdpSDKJavaCodegen", date = "2026-06-05T07:54:43.135-07:00")
public class FreeipaDiagnosticsCollectionResponse extends CdpResponse {
   ...
   **/
  private FreeipaDiagnosticsCollectionDetailsResponse collectionDetails = null;
  ...
  public boolean equals(java.lang.Object o) {
    ...
    if (!Objects.equals(this.status, freeipaDiagnosticsCollectionResponse.status)) {
      return false;
    }
    if (!Objects.equals(this.flowId, freeipaDiagnosticsCollectionResponse.flowId)) {
      return false;
    }
    if (!Objects.equals(this.flowState, freeipaDiagnosticsCollectionResponse.flowState)) {
      return false;
    }
    if (!Objects.equals(this.created, freeipaDiagnosticsCollectionResponse.created)) {
      return false;
    }
    if (!Objects.equals(this.progressPercentage, freeipaDiagnosticsCollectionResponse.progressPercentage)) {
      return false;
    }
    if (!Objects.equals(this.collectionDetails, freeipaDiagnosticsCollectionResponse.collectionDetails)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
