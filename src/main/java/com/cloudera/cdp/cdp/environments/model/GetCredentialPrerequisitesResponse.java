...
public class GetCredentialPrerequisitesResponse extends CdpResponse {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    if (!Objects.equals(this.cloudPlatform, getCredentialPrerequisitesResponse.cloudPlatform)) {
      return false;
    }
    if (!Objects.equals(this.accountId, getCredentialPrerequisitesResponse.accountId)) {
      return false;
    }
    if (!Objects.equals(this.aws, getCredentialPrerequisitesResponse.aws)) {
      return false;
    }
    if (!Objects.equals(this.azure, getCredentialPrerequisitesResponse.azure)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
