...
public class UpscaleFreeipaResponse extends CdpResponse {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    if (!Objects.equals(this.originalAvailabilityType, upscaleFreeipaResponse.originalAvailabilityType)) {
      return false;
    }
    if (!Objects.equals(this.targetAvailabilityType, upscaleFreeipaResponse.targetAvailabilityType)) {
      return false;
    }
    if (!Objects.equals(this.operationId, upscaleFreeipaResponse.operationId)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
