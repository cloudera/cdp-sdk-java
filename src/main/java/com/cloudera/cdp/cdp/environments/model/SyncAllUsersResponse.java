...
public class SyncAllUsersResponse extends CdpResponse {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SyncAllUsersResponse syncAllUsersResponse = (SyncAllUsersResponse) o;
    if (!Objects.equals(this.operationId, syncAllUsersResponse.operationId)) {
      return false;
    }
    if (!Objects.equals(this.operationType, syncAllUsersResponse.operationType)) {
      return false;
    }
    if (!Objects.equals(this.status, syncAllUsersResponse.status)) {
      return false;
    }
    if (!Objects.equals(this.success, syncAllUsersResponse.success)) {
      return false;
    }
    if (!Objects.equals(this.failure, syncAllUsersResponse.failure)) {
      return false;
    }
    if (!Objects.equals(this.error, syncAllUsersResponse.error)) {
      return false;
    }
    if (!Objects.equals(this.startTime, syncAllUsersResponse.startTime)) {
      return false;
    }
    if (!Objects.equals(this.endTime, syncAllUsersResponse.endTime)) {
      return false;
    }
    if (!Objects.equals(this.startDate, syncAllUsersResponse.startDate)) {
      return false;
    }
    if (!Objects.equals(this.endDate, syncAllUsersResponse.endDate)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
  ...
  public String toString() {
    ...
    sb.append("class SyncAllUsersResponse {\n");
