...
public class AzureComputeClusterConfiguration  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    if (!Objects.equals(this.privateCluster, azureComputeClusterConfiguration.privateCluster)) {
      return false;
    }
    if (!Objects.equals(this.kubeApiAuthorizedIpRanges, azureComputeClusterConfiguration.kubeApiAuthorizedIpRanges)) {
      return false;
    }
    if (!Objects.equals(this.outboundType, azureComputeClusterConfiguration.outboundType)) {
      return false;
    }
    if (!Objects.equals(this.workerNodeSubnets, azureComputeClusterConfiguration.workerNodeSubnets)) {
      return false;
    }
    return true;
  }
