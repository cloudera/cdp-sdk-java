...
public class SyncStatusResponse extends CdpResponse {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    if (!Objects.equals(this.operationId, syncStatusResponse.operationId)) {
      return false;
    }
    if (!Objects.equals(this.operationType, syncStatusResponse.operationType)) {
      return false;
    }
    if (!Objects.equals(this.status, syncStatusResponse.status)) {
      return false;
    }
    if (!Objects.equals(this.success, syncStatusResponse.success)) {
      return false;
    }
    if (!Objects.equals(this.failure, syncStatusResponse.failure)) {
      return false;
    }
    if (!Objects.equals(this.error, syncStatusResponse.error)) {
      return false;
    }
    if (!Objects.equals(this.startTime, syncStatusResponse.startTime)) {
      return false;
    }
