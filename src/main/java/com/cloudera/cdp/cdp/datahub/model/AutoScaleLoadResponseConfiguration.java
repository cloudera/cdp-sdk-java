...
public class AutoScaleLoadResponseConfiguration  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AutoScaleLoadResponseConfiguration autoScaleLoadResponseConfiguration = (AutoScaleLoadResponseConfiguration) o;
    if (!Objects.equals(this.minResourceValue, autoScaleLoadResponseConfiguration.minResourceValue)) {
      return false;
    }
    if (!Objects.equals(this.maxResourceValue, autoScaleLoadResponseConfiguration.maxResourceValue)) {
      return false;
    }
    if (!Objects.equals(this.coolDownMinutes, autoScaleLoadResponseConfiguration.coolDownMinutes)) {
      return false;
    }
    return true;
  }
  ...
  public String toString() {
    ...
    sb.append("class AutoScaleLoadResponseConfiguration {\n");
