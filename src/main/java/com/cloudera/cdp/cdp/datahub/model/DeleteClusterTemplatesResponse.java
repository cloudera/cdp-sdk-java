...
public class DeleteClusterTemplatesResponse extends CdpResponse {

  /**
   * The cluster templates.
   **/
  private List<ClusterTemplate> clusterTemplates = new ArrayList<ClusterTemplate>();
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DeleteClusterTemplatesResponse deleteClusterTemplatesResponse = (DeleteClusterTemplatesResponse) o;
    if (!Objects.equals(this.clusterTemplates, deleteClusterTemplatesResponse.clusterTemplates)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
  ...
  public String toString() {
    ...
    sb.append("class DeleteClusterTemplatesResponse {\n");
