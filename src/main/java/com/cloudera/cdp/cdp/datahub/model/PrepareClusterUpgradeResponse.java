...
public class PrepareClusterUpgradeResponse extends CdpResponse {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PrepareClusterUpgradeResponse prepareClusterUpgradeResponse = (PrepareClusterUpgradeResponse) o;
    if (!Objects.equals(this.current, prepareClusterUpgradeResponse.current)) {
      return false;
    }
    if (!Objects.equals(this.upgradeCandidates, prepareClusterUpgradeResponse.upgradeCandidates)) {
      return false;
    }
  ...
  public String toString() {
    ...
    sb.append("class PrepareClusterUpgradeResponse {\n");
