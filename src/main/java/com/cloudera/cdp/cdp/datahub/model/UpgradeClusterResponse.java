...
import com.cloudera.cdp.datahub.model.ImageInfo;
import java.util.*;
...
public class UpgradeClusterResponse extends CdpResponse {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    if (!Objects.equals(this.current, upgradeClusterResponse.current)) {
      return false;
    }
    if (!Objects.equals(this.upgradeCandidates, upgradeClusterResponse.upgradeCandidates)) {
      return false;
    }
    if (!Objects.equals(this.reason, upgradeClusterResponse.reason)) {
      return false;
    }
    if (!Objects.equals(this.operationId, upgradeClusterResponse.operationId)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
