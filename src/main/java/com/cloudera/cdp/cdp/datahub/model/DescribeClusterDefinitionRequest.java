...
public class DescribeClusterDefinitionRequest  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DescribeClusterDefinitionRequest describeClusterDefinitionRequest = (DescribeClusterDefinitionRequest) o;
    if (!Objects.equals(this.clusterDefinitionName, describeClusterDefinitionRequest.clusterDefinitionName)) {
      return false;
    }
    return true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clusterDefinitionName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeClusterDefinitionRequest {\n");
