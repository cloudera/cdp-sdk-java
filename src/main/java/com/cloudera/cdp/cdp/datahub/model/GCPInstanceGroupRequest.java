...
public class GCPInstanceGroupRequest  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GCPInstanceGroupRequest gCPInstanceGroupRequest = (GCPInstanceGroupRequest) o;
    if (!Objects.equals(this.nodeCount, gCPInstanceGroupRequest.nodeCount)) {
      return false;
    }
    if (!Objects.equals(this.instanceGroupName, gCPInstanceGroupRequest.instanceGroupName)) {
      return false;
    }
    if (!Objects.equals(this.instanceGroupType, gCPInstanceGroupRequest.instanceGroupType)) {
      return false;
    }
    if (!Objects.equals(this.instanceType, gCPInstanceGroupRequest.instanceType)) {
      return false;
    }
    if (!Objects.equals(this.rootVolumeSize, gCPInstanceGroupRequest.rootVolumeSize)) {
      return false;
    }
    if (!Objects.equals(this.attachedVolumeConfiguration, gCPInstanceGroupRequest.attachedVolumeConfiguration)) {
      return false;
    }
    if (!Objects.equals(this.recipeNames, gCPInstanceGroupRequest.recipeNames)) {
      return false;
    }
  ...
  public String toString() {
    ...
    sb.append("class GCPInstanceGroupRequest {\n");
