...
public class InstanceGroupRecipeRequest  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    InstanceGroupRecipeRequest instanceGroupRecipeRequest = (InstanceGroupRecipeRequest) o;
    if (!Objects.equals(this.instanceGroupName, instanceGroupRecipeRequest.instanceGroupName)) {
      return false;
    }
    if (!Objects.equals(this.recipeNames, instanceGroupRecipeRequest.recipeNames)) {
      return false;
    }
    return true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(instanceGroupName, recipeNames);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InstanceGroupRecipeRequest {\n");
