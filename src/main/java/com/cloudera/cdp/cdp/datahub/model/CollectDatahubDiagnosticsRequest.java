...
public class CollectDatahubDiagnosticsRequest  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    if (!Objects.equals(this.includeNginxReport, collectDatahubDiagnosticsRequest.includeNginxReport)) {
      return false;
    }
    if (!Objects.equals(this.includeSaltLogs, collectDatahubDiagnosticsRequest.includeSaltLogs)) {
      return false;
    }
    if (!Objects.equals(this.includeSarOutput, collectDatahubDiagnosticsRequest.includeSarOutput)) {
      return false;
    }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(crn, destination, description, caseNumber, labels, startDate, endDate, additionalLogs, hosts, hostGroups, excludeHosts, skipUnresponsiveHosts, includeNginxReport, includeSaltLogs, includeSarOutput, updatePackage, storageValidation);
  }
