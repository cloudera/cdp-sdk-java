...
public class ValidateCustomNarConfigurationRequest  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ValidateCustomNarConfigurationRequest validateCustomNarConfigurationRequest = (ValidateCustomNarConfigurationRequest) o;
    if (!Objects.equals(this.environmentCrn, validateCustomNarConfigurationRequest.environmentCrn)) {
      return false;
    }
    if (!Objects.equals(this.username, validateCustomNarConfigurationRequest.username)) {
      return false;
    }
    if (!Objects.equals(this.password, validateCustomNarConfigurationRequest.password)) {
      return false;
    }
    if (!Objects.equals(this.storageLocation, validateCustomNarConfigurationRequest.storageLocation)) {
      return false;
    }
  ...
  public String toString() {
    ...
    sb.append("class ValidateCustomNarConfigurationRequest {\n");
