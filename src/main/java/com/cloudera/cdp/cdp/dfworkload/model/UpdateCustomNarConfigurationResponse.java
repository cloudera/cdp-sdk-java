...
public class UpdateCustomNarConfigurationResponse extends CdpResponse {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UpdateCustomNarConfigurationResponse updateCustomNarConfigurationResponse = (UpdateCustomNarConfigurationResponse) o;
    if (!Objects.equals(this.username, updateCustomNarConfigurationResponse.username)) {
      return false;
    }
    if (!Objects.equals(this.password, updateCustomNarConfigurationResponse.password)) {
      return false;
    }
    if (!Objects.equals(this.storageLocation, updateCustomNarConfigurationResponse.storageLocation)) {
      return false;
    }
    if (!Objects.equals(this.configurationVersion, updateCustomNarConfigurationResponse.configurationVersion)) {
      return false;
    }
    if (!Objects.equals(this.projectCrn, updateCustomNarConfigurationResponse.projectCrn)) {
      return false;
    }
    if (!Objects.equals(this.crn, updateCustomNarConfigurationResponse.crn)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
  ...
  public String toString() {
    ...
    sb.append("class UpdateCustomNarConfigurationResponse {\n");
