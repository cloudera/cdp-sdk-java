...
public class UpdateDeploymentRequest  {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(environmentCrn, configurationVersion, deploymentCrn, parameterGroups, autoScalingEnabled, autoScaleMinNodes, autoScaleMaxNodes, staticNodeCount, kpis, assetUpdateRequestCrn);
  }
