...
public class SuspendTestSessionRequest  {
  ...
  /**
   * The CRN for the flow designer draft to be suspended.
   **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SuspendTestSessionRequest suspendTestSessionRequest = (SuspendTestSessionRequest) o;
    if (!Objects.equals(this.environmentCrn, suspendTestSessionRequest.environmentCrn)) {
      return false;
    }
    if (!Objects.equals(this.flowDraftCrn, suspendTestSessionRequest.flowDraftCrn)) {
      return false;
    }
    return true;
  }
  ...
  public String toString() {
    ...
    sb.append("class SuspendTestSessionRequest {\n");
