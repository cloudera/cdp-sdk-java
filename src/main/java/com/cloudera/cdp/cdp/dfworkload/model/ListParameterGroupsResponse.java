...
import com.cloudera.cdp.dfworkload.model.ParameterGroupSummary;
import java.util.*;
...
public class ListParameterGroupsResponse extends CdpResponse {
   ...
   **/
  private List<ParameterGroupSummary> parameterGroups = new ArrayList<ParameterGroupSummary>();
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ListParameterGroupsResponse listParameterGroupsResponse = (ListParameterGroupsResponse) o;
    if (!Objects.equals(this.parameterGroups, listParameterGroupsResponse.parameterGroups)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(parameterGroups, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListParameterGroupsResponse {\n");
