...
public class DeployedFlow  {
  ...
  /**
   * The id of the project the deployment belongs to, or null if does not belong to a project.
   **/
  ...
  /**
   * The deployed flow definition version id.
   **/
  ...
  /**
   * Getter for flowVersionId.
   * The deployed flow definition version id.
   **/
  @JsonProperty("flowVersionId")
  public String getFlowVersionId() {
    return flowVersionId;
  }

  /**
   * Setter for flowVersionId.
   * The deployed flow definition version id.
   **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    if (!Objects.equals(this.id, deployedFlow.id)) {
      return false;
    }
    if (!Objects.equals(this.status, deployedFlow.status)) {
      return false;
    }
    if (!Objects.equals(this.deploymentId, deployedFlow.deploymentId)) {
      return false;
    }
    if (!Objects.equals(this.configurationVersion, deployedFlow.configurationVersion)) {
      return false;
    }
    if (!Objects.equals(this.targetProcessGroupId, deployedFlow.targetProcessGroupId)) {
      return false;
    }
    ...
    if (!Objects.equals(this.environmentId, deployedFlow.environmentId)) {
      return false;
    }
    if (!Objects.equals(this.environment, deployedFlow.environment)) {
      return false;
    }
    ...
    if (!Objects.equals(this.projectId, deployedFlow.projectId)) {
      return false;
    }
    if (!Objects.equals(this.project, deployedFlow.project)) {
      return false;
    }
    if (!Objects.equals(this.artifactName, deployedFlow.artifactName)) {
      return false;
    }
    if (!Objects.equals(this.catalogItemId, deployedFlow.catalogItemId)) {
      return false;
    }
    ...
    if (!Objects.equals(this.artifactTypeName, deployedFlow.artifactTypeName)) {
      return false;
    }
    if (!Objects.equals(this.deployedByUsername, deployedFlow.deployedByUsername)) {
      return false;
    }
    if (!Objects.equals(this.deployedByName, deployedFlow.deployedByName)) {
      return false;
    }
    if (!Objects.equals(this.flowVersionId, deployedFlow.flowVersionId)) {
      return false;
    }
    ...
    if (!Objects.equals(this.validActions, deployedFlow.validActions)) {
      return false;
    }
    if (!Objects.equals(this.dataSent, deployedFlow.dataSent)) {
      return false;
    }
    if (!Objects.equals(this.dataReceived, deployedFlow.dataReceived)) {
      return false;
    }
    return true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, status, deploymentId, configurationVersion, targetProcessGroupId, name, activeInfoAlertCount, activeWarningAlertCount, activeErrorAlertCount, environmentId, environment, deploymentName, crn, projectId, project, artifactName, catalogItemId, flowVersion, flowVersionCrn, flowCrn, creatorCrn, artifactTypeName, deployedByUsername, deployedByName, flowVersionId, created, updated, validActions, dataSent, dataReceived);
  }
