...
public class SuspendTestSessionResponse extends CdpResponse {

  /**
   * The suspended runtime session.
   **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SuspendTestSessionResponse suspendTestSessionResponse = (SuspendTestSessionResponse) o;
    if (!Objects.equals(this.runtimeSession, suspendTestSessionResponse.runtimeSession)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
  ...
  public String toString() {
    ...
    sb.append("class SuspendTestSessionResponse {\n");
