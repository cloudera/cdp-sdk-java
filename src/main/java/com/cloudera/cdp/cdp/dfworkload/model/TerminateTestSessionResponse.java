...
public class TerminateTestSessionResponse extends CdpResponse {

  /**
   * The terminated runtime session.
   **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TerminateTestSessionResponse terminateTestSessionResponse = (TerminateTestSessionResponse) o;
    if (!Objects.equals(this.runtimeSession, terminateTestSessionResponse.runtimeSession)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
  ...
  public String toString() {
    ...
    sb.append("class TerminateTestSessionResponse {\n");
