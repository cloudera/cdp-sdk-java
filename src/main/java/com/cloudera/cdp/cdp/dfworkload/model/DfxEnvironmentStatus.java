...
public class DfxEnvironmentStatus  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DfxEnvironmentStatus dfxEnvironmentStatus = (DfxEnvironmentStatus) o;
    if (!Objects.equals(this.detailedState, dfxEnvironmentStatus.detailedState)) {
      return false;
    }
    if (!Objects.equals(this.message, dfxEnvironmentStatus.message)) {
      return false;
    }
    if (!Objects.equals(this.state, dfxEnvironmentStatus.state)) {
      return false;
    }
    return true;
  }
  ...
  public String toString() {
    ...
    sb.append("class DfxEnvironmentStatus {\n");
