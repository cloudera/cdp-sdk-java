...
public class DeployedFlowMetadata  {
   ...
   **/
  private String flowDefinitionName = null;
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DeployedFlowMetadata deployedFlowMetadata = (DeployedFlowMetadata) o;
    if (!Objects.equals(this.deployedFlowName, deployedFlowMetadata.deployedFlowName)) {
      return false;
    }
    if (!Objects.equals(this.flowDefinitionName, deployedFlowMetadata.flowDefinitionName)) {
      return false;
    }
    return true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(deployedFlowName, flowDefinitionName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeployedFlowMetadata {\n");
