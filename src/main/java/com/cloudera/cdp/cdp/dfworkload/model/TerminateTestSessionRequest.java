...
public class TerminateTestSessionRequest  {
  ...
  /**
   * The CRN for the flow designer draft to be terminated.
   **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TerminateTestSessionRequest terminateTestSessionRequest = (TerminateTestSessionRequest) o;
    if (!Objects.equals(this.environmentCrn, terminateTestSessionRequest.environmentCrn)) {
      return false;
    }
    if (!Objects.equals(this.flowDraftCrn, terminateTestSessionRequest.flowDraftCrn)) {
      return false;
    }
    return true;
  }
  ...
  public String toString() {
    ...
    sb.append("class TerminateTestSessionRequest {\n");
