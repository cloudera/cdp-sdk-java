...
public class RpcDeployedFlowConfigurationMetadata  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RpcDeployedFlowConfigurationMetadata rpcDeployedFlowConfigurationMetadata = (RpcDeployedFlowConfigurationMetadata) o;
    if (!Objects.equals(this.flowCrn, rpcDeployedFlowConfigurationMetadata.flowCrn)) {
      return false;
    }
    if (!Objects.equals(this.flowName, rpcDeployedFlowConfigurationMetadata.flowName)) {
      return false;
    }
    if (!Objects.equals(this.flowVersion, rpcDeployedFlowConfigurationMetadata.flowVersion)) {
      return false;
    }
    if (!Objects.equals(this.flowVersionCrn, rpcDeployedFlowConfigurationMetadata.flowVersionCrn)) {
      return false;
    }
    if (!Objects.equals(this.requiresEnvironmentSslContextService, rpcDeployedFlowConfigurationMetadata.requiresEnvironmentSslContextService)) {
      return false;
    }
    if (!Objects.equals(this.artifactTypeName, rpcDeployedFlowConfigurationMetadata.artifactTypeName)) {
      return false;
    }
    if (!Objects.equals(this.parameterGroups, rpcDeployedFlowConfigurationMetadata.parameterGroups)) {
      return false;
    }
    if (!Objects.equals(this.kpiMetaData, rpcDeployedFlowConfigurationMetadata.kpiMetaData)) {
      return false;
    }
    return true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(flowCrn, flowName, flowVersion, flowVersionCrn, requiresEnvironmentSslContextService, artifactTypeName, parameterGroups, kpiMetaData);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RpcDeployedFlowConfigurationMetadata {\n");
