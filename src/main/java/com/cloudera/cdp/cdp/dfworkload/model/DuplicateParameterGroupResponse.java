...
public class DuplicateParameterGroupResponse extends CdpResponse {

  /**
   * The duplicated parameter group.
   **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DuplicateParameterGroupResponse duplicateParameterGroupResponse = (DuplicateParameterGroupResponse) o;
    if (!Objects.equals(this.parameterGroup, duplicateParameterGroupResponse.parameterGroup)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
  ...
  public String toString() {
    ...
    sb.append("class DuplicateParameterGroupResponse {\n");
