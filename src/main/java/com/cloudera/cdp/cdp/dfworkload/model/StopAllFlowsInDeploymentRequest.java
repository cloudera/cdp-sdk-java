...
public class StopAllFlowsInDeploymentRequest  {
  ...
  /**
   * The max time in minutes to wait for flows to stop.
   **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StopAllFlowsInDeploymentRequest stopAllFlowsInDeploymentRequest = (StopAllFlowsInDeploymentRequest) o;
    if (!Objects.equals(this.environmentCrn, stopAllFlowsInDeploymentRequest.environmentCrn)) {
      return false;
    }
    if (!Objects.equals(this.deploymentCrn, stopAllFlowsInDeploymentRequest.deploymentCrn)) {
      return false;
    }
    if (!Objects.equals(this.waitForFlowToStopInMinutes, stopAllFlowsInDeploymentRequest.waitForFlowToStopInMinutes)) {
      return false;
    }
    return true;
  }
  ...
  public String toString() {
    ...
    sb.append("class StopAllFlowsInDeploymentRequest {\n");
