...
public class CancelChangeFlowVersionResponse extends CdpResponse {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CancelChangeFlowVersionResponse cancelChangeFlowVersionResponse = (CancelChangeFlowVersionResponse) o;
    if (!Objects.equals(this.deploymentConfiguration, cancelChangeFlowVersionResponse.deploymentConfiguration)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(deploymentConfiguration, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CancelChangeFlowVersionResponse {\n");
