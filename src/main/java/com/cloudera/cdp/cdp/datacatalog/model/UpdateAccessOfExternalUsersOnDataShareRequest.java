...
public class UpdateAccessOfExternalUsersOnDataShareRequest  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UpdateAccessOfExternalUsersOnDataShareRequest updateAccessOfExternalUsersOnDataShareRequest = (UpdateAccessOfExternalUsersOnDataShareRequest) o;
    if (!Objects.equals(this.datalakeCrn, updateAccessOfExternalUsersOnDataShareRequest.datalakeCrn)) {
      return false;
    }
    if (!Objects.equals(this.environmentCrn, updateAccessOfExternalUsersOnDataShareRequest.environmentCrn)) {
      return false;
    }
    if (!Objects.equals(this.dataShareId, updateAccessOfExternalUsersOnDataShareRequest.dataShareId)) {
      return false;
    }
    if (!Objects.equals(this.externalUsers, updateAccessOfExternalUsersOnDataShareRequest.externalUsers)) {
      return false;
    }
    return true;
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateAccessOfExternalUsersOnDataShareRequest {\n");
