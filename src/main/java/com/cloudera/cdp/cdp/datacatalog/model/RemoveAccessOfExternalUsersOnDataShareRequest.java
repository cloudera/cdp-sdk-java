...
public class RemoveAccessOfExternalUsersOnDataShareRequest  {
   ...
   **/
  private List<Long> externalUserIds = new ArrayList<Long>();
  ...
  /**
   * Getter for externalUserIds.
   * List of external user Ids whose access will be removed.
   **/
  @JsonProperty("externalUserIds")
  public List<Long> getExternalUserIds() {
    return externalUserIds;
  }

  /**
   * Setter for externalUserIds.
   * List of external user Ids whose access will be removed.
   **/
  public void setExternalUserIds(List<Long> externalUserIds) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RemoveAccessOfExternalUsersOnDataShareRequest removeAccessOfExternalUsersOnDataShareRequest = (RemoveAccessOfExternalUsersOnDataShareRequest) o;
    if (!Objects.equals(this.datalakeCrn, removeAccessOfExternalUsersOnDataShareRequest.datalakeCrn)) {
      return false;
    }
    if (!Objects.equals(this.environmentCrn, removeAccessOfExternalUsersOnDataShareRequest.environmentCrn)) {
      return false;
    }
    if (!Objects.equals(this.dataShareId, removeAccessOfExternalUsersOnDataShareRequest.dataShareId)) {
      return false;
    }
    if (!Objects.equals(this.externalUserIds, removeAccessOfExternalUsersOnDataShareRequest.externalUserIds)) {
      return false;
    }
    return true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(datalakeCrn, environmentCrn, dataShareId, externalUserIds);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RemoveAccessOfExternalUsersOnDataShareRequest {\n");
