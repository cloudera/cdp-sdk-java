...
import com.cloudera.cdp.datacatalog.model.CreateExternalUser;
import java.util.*;
...
public class CreateExternalUsersRequest  {
   ...
   **/
  private List<CreateExternalUser> externalUsers = new ArrayList<CreateExternalUser>();
  ...
  public List<CreateExternalUser> getExternalUsers() {
   ...
   * List of external users to be created.
   **/
  public void setExternalUsers(List<CreateExternalUser> externalUsers) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreateExternalUsersRequest createExternalUsersRequest = (CreateExternalUsersRequest) o;
    if (!Objects.equals(this.datalakeCrn, createExternalUsersRequest.datalakeCrn)) {
      return false;
    }
    if (!Objects.equals(this.environmentCrn, createExternalUsersRequest.environmentCrn)) {
      return false;
    }
    if (!Objects.equals(this.externalUsers, createExternalUsersRequest.externalUsers)) {
      return false;
    }
    return true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(datalakeCrn, environmentCrn, externalUsers);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateExternalUsersRequest {\n");
