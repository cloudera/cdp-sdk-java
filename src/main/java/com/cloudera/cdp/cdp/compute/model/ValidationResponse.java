...
public class ValidationResponse extends CdpResponse {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    if (!Objects.equals(this.result, validationResponse.result)) {
      return false;
    }
    if (!Objects.equals(this.summary, validationResponse.summary)) {
      return false;
    }
    if (!Objects.equals(this.message, validationResponse.message)) {
      return false;
    }
    if (!Objects.equals(this.validations, validationResponse.validations)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
