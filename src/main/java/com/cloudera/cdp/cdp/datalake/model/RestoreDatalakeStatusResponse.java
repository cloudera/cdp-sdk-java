 ...
 **/
@jakarta.annotation.Generated(value = "com.cloudera.cdp.client.codegen.CdpSDKJavaCodegen", date = "2026-05-01T09:59:27.966-07:00")
public class RestoreDatalakeStatusResponse extends CdpResponse {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RestoreDatalakeStatusResponse restoreDatalakeStatusResponse = (RestoreDatalakeStatusResponse) o;
    if (!Objects.equals(this.accountId, restoreDatalakeStatusResponse.accountId)) {
      return false;
    }
    if (!Objects.equals(this.restoreId, restoreDatalakeStatusResponse.restoreId)) {
      return false;
    }
    if (!Objects.equals(this.backupId, restoreDatalakeStatusResponse.backupId)) {
      return false;
    }
    if (!Objects.equals(this.userCrn, restoreDatalakeStatusResponse.userCrn)) {
      return false;
    }
    if (!Objects.equals(this.internalState, restoreDatalakeStatusResponse.internalState)) {
      return false;
    }
    if (!Objects.equals(this.status, restoreDatalakeStatusResponse.status)) {
      return false;
    }
    if (!Objects.equals(this.startTime, restoreDatalakeStatusResponse.startTime)) {
      return false;
    }
    if (!Objects.equals(this.endTime, restoreDatalakeStatusResponse.endTime)) {
      return false;
    }
    if (!Objects.equals(this.backupLocation, restoreDatalakeStatusResponse.backupLocation)) {
      return false;
    }
    if (!Objects.equals(this.operationStates, restoreDatalakeStatusResponse.operationStates)) {
      return false;
    }
    if (!Objects.equals(this.backupName, restoreDatalakeStatusResponse.backupName)) {
      return false;
    }
    if (!Objects.equals(this.failureReason, restoreDatalakeStatusResponse.failureReason)) {
      return false;
    }
    if (!Objects.equals(this.runtimeVersion, restoreDatalakeStatusResponse.runtimeVersion)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
  ...
  public String toString() {
    ...
    sb.append("class RestoreDatalakeStatusResponse {\n");
