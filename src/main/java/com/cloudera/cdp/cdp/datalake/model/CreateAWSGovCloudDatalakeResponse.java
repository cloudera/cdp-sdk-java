...
public class CreateAWSGovCloudDatalakeResponse extends CdpResponse {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreateAWSGovCloudDatalakeResponse createAWSGovCloudDatalakeResponse = (CreateAWSGovCloudDatalakeResponse) o;
    if (!Objects.equals(this.datalake, createAWSGovCloudDatalakeResponse.datalake)) {
      return false;
    }
    if (!Objects.equals(this.operationId, createAWSGovCloudDatalakeResponse.operationId)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
  ...
  public String toString() {
    ...
    sb.append("class CreateAWSGovCloudDatalakeResponse {\n");
