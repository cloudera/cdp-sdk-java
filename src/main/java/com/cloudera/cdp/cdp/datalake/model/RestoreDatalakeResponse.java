...
public class RestoreDatalakeResponse extends CdpResponse {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RestoreDatalakeResponse restoreDatalakeResponse = (RestoreDatalakeResponse) o;
    if (!Objects.equals(this.accountId, restoreDatalakeResponse.accountId)) {
      return false;
    }
    if (!Objects.equals(this.restoreId, restoreDatalakeResponse.restoreId)) {
      return false;
    }
    if (!Objects.equals(this.backupId, restoreDatalakeResponse.backupId)) {
      return false;
    }
    if (!Objects.equals(this.userCrn, restoreDatalakeResponse.userCrn)) {
      return false;
    }
    if (!Objects.equals(this.internalState, restoreDatalakeResponse.internalState)) {
      return false;
    }
    if (!Objects.equals(this.status, restoreDatalakeResponse.status)) {
      return false;
    }
    if (!Objects.equals(this.startTime, restoreDatalakeResponse.startTime)) {
      return false;
    }
    if (!Objects.equals(this.endTime, restoreDatalakeResponse.endTime)) {
      return false;
    }
  ...
  public String toString() {
    ...
    sb.append("class RestoreDatalakeResponse {\n");
