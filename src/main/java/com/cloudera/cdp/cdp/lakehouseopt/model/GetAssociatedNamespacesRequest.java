...
public class GetAssociatedNamespacesRequest  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GetAssociatedNamespacesRequest getAssociatedNamespacesRequest = (GetAssociatedNamespacesRequest) o;
    if (!Objects.equals(this.datahubCrn, getAssociatedNamespacesRequest.datahubCrn)) {
      return false;
    }
    if (!Objects.equals(this.policyName, getAssociatedNamespacesRequest.policyName)) {
      return false;
    }
    return true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(datahubCrn, policyName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetAssociatedNamespacesRequest {\n");
