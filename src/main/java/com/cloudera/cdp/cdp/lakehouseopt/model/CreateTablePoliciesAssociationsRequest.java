...
public class CreateTablePoliciesAssociationsRequest  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreateTablePoliciesAssociationsRequest createTablePoliciesAssociationsRequest = (CreateTablePoliciesAssociationsRequest) o;
    if (!Objects.equals(this.datahubCrn, createTablePoliciesAssociationsRequest.datahubCrn)) {
      return false;
    }
    if (!Objects.equals(this.namespace, createTablePoliciesAssociationsRequest.namespace)) {
      return false;
    }
    if (!Objects.equals(this.tableName, createTablePoliciesAssociationsRequest.tableName)) {
      return false;
    }
    if (!Objects.equals(this.policies, createTablePoliciesAssociationsRequest.policies)) {
      return false;
    }
    return true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(datahubCrn, namespace, tableName, policies);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateTablePoliciesAssociationsRequest {\n");
