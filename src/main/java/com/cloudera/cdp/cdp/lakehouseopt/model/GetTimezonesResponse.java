...
import com.cloudera.cdp.lakehouseopt.model.TimezoneObject;
import java.util.*;
...
public class GetTimezonesResponse extends CdpResponse {

  /**
   * The list of all supported timezones.
   **/
  private List<TimezoneObject> timezones = new ArrayList<TimezoneObject>();

  /**
   * Getter for timezones.
   * The list of all supported timezones.
   **/
  @JsonProperty("timezones")
  public List<TimezoneObject> getTimezones() {
    return timezones;
  }

  /**
   * Setter for timezones.
   * The list of all supported timezones.
   **/
  public void setTimezones(List<TimezoneObject> timezones) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    if (!Objects.equals(this.timezones, getTimezonesResponse.timezones)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(timezones, super.hashCode());
  }
