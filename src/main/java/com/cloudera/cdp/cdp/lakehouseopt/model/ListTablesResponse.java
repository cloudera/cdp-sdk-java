...
import com.cloudera.cdp.lakehouseopt.model.TableObject;
import java.util.*;
...
public class ListTablesResponse extends CdpResponse {
   ...
   * List of all tables for a particular namespace
   **/
  public void setTables(List<TableObject> tables) {
    this.tables = tables;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    if (!Objects.equals(this.tables, listTablesResponse.tables)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
