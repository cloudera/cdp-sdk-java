...
public class GetDatahubCrnResponse extends CdpResponse {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GetDatahubCrnResponse getDatahubCrnResponse = (GetDatahubCrnResponse) o;
    if (!Objects.equals(this.datahubCrn, getDatahubCrnResponse.datahubCrn)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(datahubCrn, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetDatahubCrnResponse {\n");
