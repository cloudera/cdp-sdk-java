...
public class LakehouseoptClientBuilder extends CdpClientBuilder<LakehouseoptClientBuilder> {

  private LakehouseoptClientBuilder() {
   super(LakehouseoptClient.SERVICE_NAME, true);
  }

  /**
   * Return the client with all the default configuration settings.
   * @return LakehouseoptClient
   */
  public static LakehouseoptClient defaultClient() {
   ...
   * @return LakehouseoptClientBuilder
   */
  public static LakehouseoptClientBuilder defaultBuilder() {
    return new LakehouseoptClientBuilder();
  }
   ...
   * @return LakehouseoptClient
   */
  public LakehouseoptClient build() {
    return new LakehouseoptClient(
  ...
  @Override
  public LakehouseoptClientBuilder self() {
    return this;
  }
}