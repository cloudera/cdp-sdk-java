...
public class Script  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    if (!Objects.equals(this.name, script.name)) {
      return false;
    }
    if (!Objects.equals(this.uri, script.uri)) {
      return false;
    }
    if (!Objects.equals(this.description, script.description)) {
      return false;
    }
    return true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, uri, description);
  }
