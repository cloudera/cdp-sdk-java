...
public class GetPolicyNamesResponse extends CdpResponse {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GetPolicyNamesResponse getPolicyNamesResponse = (GetPolicyNamesResponse) o;
    if (!Objects.equals(this.policyNames, getPolicyNamesResponse.policyNames)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(policyNames, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetPolicyNamesResponse {\n");
