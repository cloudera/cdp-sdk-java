...
public class GetAssociationDetailsRequest  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GetAssociationDetailsRequest getAssociationDetailsRequest = (GetAssociationDetailsRequest) o;
    if (!Objects.equals(this.datahubCrn, getAssociationDetailsRequest.datahubCrn)) {
      return false;
    }
    return true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(datahubCrn);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetAssociationDetailsRequest {\n");
