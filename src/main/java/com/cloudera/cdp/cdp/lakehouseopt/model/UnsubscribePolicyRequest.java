...
public class UnsubscribePolicyRequest  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UnsubscribePolicyRequest unsubscribePolicyRequest = (UnsubscribePolicyRequest) o;
    if (!Objects.equals(this.datahubCrn, unsubscribePolicyRequest.datahubCrn)) {
      return false;
    }
    if (!Objects.equals(this.policyName, unsubscribePolicyRequest.policyName)) {
      return false;
    }
    if (!Objects.equals(this.namespace, unsubscribePolicyRequest.namespace)) {
      return false;
    }
    if (!Objects.equals(this.tableName, unsubscribePolicyRequest.tableName)) {
      return false;
    }
    return true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(datahubCrn, policyName, namespace, tableName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UnsubscribePolicyRequest {\n");
