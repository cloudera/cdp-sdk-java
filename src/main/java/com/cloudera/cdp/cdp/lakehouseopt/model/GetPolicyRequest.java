...
public class GetPolicyRequest  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    if (!Objects.equals(this.policyName, getPolicyRequest.policyName)) {
      return false;
    }
    if (!Objects.equals(this.datahubCrn, getPolicyRequest.datahubCrn)) {
      return false;
    }
    return true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(policyName, datahubCrn);
  }
