...
public class DryRunResult  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    if (!Objects.equals(this.actions, dryRunResult.actions)) {
      return false;
    }
    if (!Objects.deepEquals(this.details, dryRunResult.details)) {
      return false;
    }
    return true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(actions, Arrays.hashCode(details));
  }
