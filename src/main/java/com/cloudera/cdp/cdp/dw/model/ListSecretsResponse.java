...
public class ListSecretsResponse extends CdpResponse {

  /**
   * The list of secrets.
   **/
  private List<Secret> result = new ArrayList<Secret>();
   ...
   * The list of secrets.
   **/
  public void setResult(List<Secret> result) {
    this.result = result;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    if (!Objects.equals(this.result, listSecretsResponse.result)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
