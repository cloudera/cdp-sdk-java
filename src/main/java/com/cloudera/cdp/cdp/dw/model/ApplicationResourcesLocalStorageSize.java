...
public class ApplicationResourcesLocalStorageSize  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ApplicationResourcesLocalStorageSize applicationResourcesLocalStorageSize = (ApplicationResourcesLocalStorageSize) o;
    if (!Objects.equals(this.scratch, applicationResourcesLocalStorageSize.scratch)) {
      return false;
    }
    if (!Objects.equals(this.cache, applicationResourcesLocalStorageSize.cache)) {
      return false;
    }
    if (!Objects.equals(this.overhead, applicationResourcesLocalStorageSize.overhead)) {
      return false;
    }
    return true;
  }
  ...
  public String toString() {
    ...
    sb.append("class ApplicationResourcesLocalStorageSize {\n");
