...
import com.cloudera.cdp.dw.model.Secret;
...
public class RegisterSecretResponse extends CdpResponse {
   ...
   * Result of the operation.
   **/
  public void setResult(Secret result) {
    this.result = result;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RegisterSecretResponse registerSecretResponse = (RegisterSecretResponse) o;
    if (!Objects.equals(this.result, registerSecretResponse.result)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
  ...
  public String toString() {
    ...
    sb.append("class RegisterSecretResponse {\n");
