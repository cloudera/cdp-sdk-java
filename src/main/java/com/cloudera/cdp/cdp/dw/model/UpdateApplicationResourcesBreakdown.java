...
public class UpdateApplicationResourcesBreakdown  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UpdateApplicationResourcesBreakdown updateApplicationResourcesBreakdown = (UpdateApplicationResourcesBreakdown) o;
    if (!Objects.equals(this.xms, updateApplicationResourcesBreakdown.xms)) {
      return false;
    }
    if (!Objects.equals(this.xmx, updateApplicationResourcesBreakdown.xmx)) {
      return false;
    }
    if (!Objects.equals(this.headroom, updateApplicationResourcesBreakdown.headroom)) {
      return false;
    }
    if (!Objects.equals(this.xss, updateApplicationResourcesBreakdown.xss)) {
      return false;
    }
    if (!Objects.equals(this.maxDirectMemorySize, updateApplicationResourcesBreakdown.maxDirectMemorySize)) {
      return false;
    }
    if (!Objects.equals(this.waitQueueSize, updateApplicationResourcesBreakdown.waitQueueSize)) {
      return false;
    }
    return true;
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateApplicationResourcesBreakdown {\n");
