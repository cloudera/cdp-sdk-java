...
public class UpgradeClusterResponse extends CdpResponse {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    if (!Objects.equals(this.status, upgradeClusterResponse.status)) {
      return false;
    }
    if (!Objects.equals(this.message, upgradeClusterResponse.message)) {
      return false;
    }
    if (!Objects.equals(this.timedOut, upgradeClusterResponse.timedOut)) {
      return false;
    }
    if (!Objects.equals(this.serviceUnhealthy, upgradeClusterResponse.serviceUnhealthy)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
