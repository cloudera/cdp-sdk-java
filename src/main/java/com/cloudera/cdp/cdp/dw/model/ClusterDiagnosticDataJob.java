...
public class ClusterDiagnosticDataJob  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ClusterDiagnosticDataJob clusterDiagnosticDataJob = (ClusterDiagnosticDataJob) o;
    if (!Objects.equals(this.jobId, clusterDiagnosticDataJob.jobId)) {
      return false;
    }
    if (!Objects.equals(this.startTime, clusterDiagnosticDataJob.startTime)) {
      return false;
    }
    if (!Objects.equals(this.endTime, clusterDiagnosticDataJob.endTime)) {
      return false;
    }
    if (!Objects.equals(this.url, clusterDiagnosticDataJob.url)) {
      return false;
    }
    if (!Objects.equals(this.status, clusterDiagnosticDataJob.status)) {
      return false;
    }
    if (!Objects.equals(this.labels, clusterDiagnosticDataJob.labels)) {
      return false;
    }
    return true;
  }
  ...
  public String toString() {
    ...
    sb.append("class ClusterDiagnosticDataJob {\n");
