...
public class CreateConnectorResponse extends CdpResponse {

  /**
   * The ID of the newly created Connector.
   **/
  private Connector result = null;
   ...
   * The ID of the newly created Connector.
   **/
  public void setResult(Connector result) {
    this.result = result;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    if (!Objects.equals(this.result, createConnectorResponse.result)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
