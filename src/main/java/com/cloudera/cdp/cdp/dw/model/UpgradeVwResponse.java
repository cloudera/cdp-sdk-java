...
public class UpgradeVwResponse extends CdpResponse {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UpgradeVwResponse upgradeVwResponse = (UpgradeVwResponse) o;
    if (!Objects.equals(this.status, upgradeVwResponse.status)) {
      return false;
    }
    if (!Objects.equals(this.message, upgradeVwResponse.message)) {
      return false;
    }
    if (!Objects.equals(this.timedOut, upgradeVwResponse.timedOut)) {
      return false;
    }
  ...
  public String toString() {
    ...
    sb.append("class UpgradeVwResponse {\n");
