...
public class CreateApplicationResourcesLocalStorageSize  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreateApplicationResourcesLocalStorageSize createApplicationResourcesLocalStorageSize = (CreateApplicationResourcesLocalStorageSize) o;
    if (!Objects.equals(this.scratch, createApplicationResourcesLocalStorageSize.scratch)) {
      return false;
    }
    if (!Objects.equals(this.cache, createApplicationResourcesLocalStorageSize.cache)) {
      return false;
    }
    if (!Objects.equals(this.overhead, createApplicationResourcesLocalStorageSize.overhead)) {
      return false;
    }
    return true;
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateApplicationResourcesLocalStorageSize {\n");
