...
public class ListScimAccessTokensRequest  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ListScimAccessTokensRequest listScimAccessTokensRequest = (ListScimAccessTokensRequest) o;
    if (!Objects.equals(this.identityProviderNameOrCrn, listScimAccessTokensRequest.identityProviderNameOrCrn)) {
      return false;
    }
    if (!Objects.equals(this.pageSize, listScimAccessTokensRequest.pageSize)) {
      return false;
    }
    if (!Objects.equals(this.startingToken, listScimAccessTokensRequest.startingToken)) {
      return false;
    }
    return true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(identityProviderNameOrCrn, pageSize, startingToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListScimAccessTokensRequest {\n");
