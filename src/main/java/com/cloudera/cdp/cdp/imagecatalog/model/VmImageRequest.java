...
public class VmImageRequest  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    VmImageRequest vmImageRequest = (VmImageRequest) o;
    if (!Objects.equals(this.region, vmImageRequest.region)) {
      return false;
    }
    if (!Objects.equals(this.imageReference, vmImageRequest.imageReference)) {
      return false;
    }
    return true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(region, imageReference);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VmImageRequest {\n");
