...
public class DescribeDefaultImageResponse extends CdpResponse {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DescribeDefaultImageResponse describeDefaultImageResponse = (DescribeDefaultImageResponse) o;
    if (!Objects.equals(this.imageId, describeDefaultImageResponse.imageId)) {
      return false;
    }
    if (!Objects.equals(this.vmImages, describeDefaultImageResponse.vmImages)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
  ...
  public String toString() {
    ...
    sb.append("class DescribeDefaultImageResponse {\n");
