...
public class ResourceResponse extends CdpResponse implements AutoCloseable {
  ...
  public InputStream readEntity() {
    checkStateAndThrow(this.response != null);
    return this.response.readEntity(InputStream.class);
  }
   ...
   * @return the message entity.
   * @see Response#readEntity(Class, Annotation[])
   */
  public InputStream readEntity(Annotation[] annotations) {
    checkStateAndThrow(this.response != null);
    return this.response.readEntity(InputStream.class, annotations);
  }
