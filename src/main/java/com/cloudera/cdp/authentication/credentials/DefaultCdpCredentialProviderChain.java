 ...
 */
public class DefaultCdpCredentialProviderChain
  extends CdpCredentialsProviderChain {

  private static final DefaultCdpCredentialProviderChain INSTANCE =
      new DefaultCdpCredentialProviderChain();

  /**
   * Constructor.
   */
  public DefaultCdpCredentialProviderChain() {
    super(new CdpEnvironmentVariableCredentialsProvider(),
   ...
   */
  public static CdpCredentialsProviderChain getInstance() {
    return INSTANCE;
  }
}
