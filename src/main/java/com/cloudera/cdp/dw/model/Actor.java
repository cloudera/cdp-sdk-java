...
public class Actor  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Actor actor = (Actor) o;
    if (!Objects.equals(this.crn, actor.crn)) {
      return false;
    }
    if (!Objects.equals(this.email, actor.email)) {
      return false;
    }
    if (!Objects.equals(this.workloadUsername, actor.workloadUsername)) {
      return false;
    }
    if (!Objects.equals(this.machineUsername, actor.machineUsername)) {
      return false;
    }
    return true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(crn, email, workloadUsername, machineUsername);
  }
